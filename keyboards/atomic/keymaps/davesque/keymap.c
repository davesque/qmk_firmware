 ...
 * |--------+--------+--------+--------+--------+- 2u ------------+--------+--------+--------+--------+-----------------+--------+--------|
 * | LOWER  | FN     | LGUI   | LALT   | LCTRL  | XXXXXX . SPACE  | RCTRL  | RALT   | RGUI   | FN     | RAISE  | LEFT   | DOWN   | RIGHT  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 ...
 [_QW] = { /* QWERTY */
  ...
  { KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,  KC_ENT,  KC_VOLU  },
 ...
 */
 ...
 [_CM] = { /* COLEMAK */
  ...
  { KC_LCTL, KC_A,    KC_R,    KC_S,    KC_T,    KC_D,    KC_H,    KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT, KC_ENT,  KC_ENT,  KC_VOLU  },
 ...
 */
 ...
 [_DV] = { /* DVORAK */
  ...
  { KC_LCTL, KC_A,    KC_O,    KC_E,    KC_U,    KC_I,    KC_D,    KC_H,    KC_T,    KC_N,    KC_S,    KC_SLSH, KC_ENT,  KC_ENT,  KC_VOLU  },
 ...
 */
 ...
 [_LW] = { /* LOWERED */
  ...
  { _______, _______, _______, _______, _______, KC_LCBR, KC_RCBR, KC_4,    KC_5,    KC_6,    _______, _______, ___T___, ___T___, _______  },
  { _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, KC_1,    KC_2,    KC_3,    _______, ___T___, ___T___, _______, _______  },
 ...
 */
 ...
 [_FN] = { /* FUNCTION */
  ...
  { _______, _______, _______, _______, _______, KC_LPRN, KC_RPRN, _______, KC_UP,   _______, _______, _______, _______, KC_DEL,  KC_END   },
  { KC_CAPS, _______, _______, _______, _______, KC_LCBR, KC_RCBR, KC_LEFT, KC_DOWN, KC_RGHT, KC_PIPE, _______, ___T___, ___T___, _______  },
  { _______, _______, DF(_QW), DF(_CM), DF(_DV), KC_LBRC, KC_RBRC, _______, _______, _______, KC_BSLS, ___T___, ___T___, _______, KC_MUTE  },
